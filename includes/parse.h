...
typedef struct s_imap// not mine
{
	int fd;
	int line_count;
	char *path;
...
typedef struct s_parse// not mine
{
	t_icords	pos;
	char **map;
	int num_lines;
	char **text;
	char *no_text;// texture
	char *so_text;// texture
	char *we_text;// texture
	char *ea_text;// texture
	unsigned int floor_color;// color
	unsigned int ceil_color;// color
	size_t column;
	size_t row;
	int *floor;
	int *ceiling;
...
// typedef struct s_ray// not mine or idk seems gae
// {
// 	double angle;
// 	struct s_data *data;
// 	double x;
